...
#elif defined(besc_esc)
#include "besc.inc"		; BESC esc
#else
...
.equ	MOTOR_ADVANCE	= 24	; Degrees of timing advance (0 - 30, 30 meaning no delay)
.endif
...
.equ	PWR_COOL_START	= (POWER_RANGE/6) ; Power limit while starting to reduce heating
...
.equ	PWR_MAX_RPM1	= (POWER_RANGE/2) ; Power limit when running slower than TIMING_RANGE1
